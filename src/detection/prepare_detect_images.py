import os
TARGET_DIR = '/home/hoangtv/data/Phong_Dat/aic23/detection'
ROOT_DATA_DIR = '/home/hoangtv/data/Phong_Dat/aic23/dataset'
ROLES = ["validation"]
...
def prcocess_file(param):
    ...
    for file in os.listdir(path):
        ...
        #Copy file
        os.system(f"cp {source_file} {target}")
    ...
    for each_role in ROLES:
        ...
        for each_scenario in scenarios:
            ...
            for each_camera in cameras:
                ...
                params_meter.append(
                    [f"{each_scenario}_{each_camera}", camera_dir, "validation"]
                )
