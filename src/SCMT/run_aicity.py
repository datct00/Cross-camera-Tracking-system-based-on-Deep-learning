...
FEAT_DIR = '/data/hoangtv/data/Phong_Dat/aic23/src/top2git/output/transformer_feat/'
DETECTION_DIR = '/data/hoangtv/data/Phong_Dat/aic23/src/top2git/datasets/detection/Yolo/'
